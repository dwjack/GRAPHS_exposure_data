...
# The overall file generated by this process is: "CO_parameters_all_(X)sessions_(DATE).rds")

# The most recent file is: 
#"~/Dropbox/Ghana_exposure_data_SHARED (1)/CO_files_processed/CO_parameters_all_11894sessions_Jun02.rds"
...
# stopped here, need to sort these out
